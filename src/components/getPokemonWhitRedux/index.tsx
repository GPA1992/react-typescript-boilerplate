...
export default function GetPokemonWhitRedux() {
	...
	return (
		<div className={styles.container}>
			...
			<br />
			<input type="text" onChange={({target}) => setPokemonName(target.value)} />
			<br />
			<button onClick={ () => dispatch(thunkGetPokemonByUsername(pokemonName.toLocaleLowerCase())) }>Teste</button>
